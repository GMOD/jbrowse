...
const FeatureCallout = props => (
  <div className="paddingBottom" style={{textAlign: 'left'}}>
    ...
    <ul>
      ...
      <li>Includes an optional “faceted” track selector (<a href="http://jbrowse.org/code/latest-release/index.html?data=sample_data/json/modencode">see demo</a>) suitable for large installations with thousands of tracks.</li>
