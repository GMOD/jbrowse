require([
  ...
  var parsedGFF3toJbrowseJsonInput2
  ...
  describe('GFF3 file inloading - turning parsed GFF3 into jbrowse json', function () {
    beforeEach(function () {
      ...
      actualJbrowseJsonOutput = store._gff3toJbrowseJson(
        parsedGFF3toJbrowseJsonInput,
      )
    })
    ...
    it('should correctly set histograms/stats/meta in jbrowse json', function () {
      expect(actualJbrowseJsonOutput['trackInfo']['histograms']).toEqual({
        stats: [{ basesPerBin: '1000000', max: 1, mean: 1 }],
        meta: [
          {
            basesPerBin: '1000000',
            arrayParams: {
        ...
        [
          ...
          [
            [
              ...
              'exon',
              '.',
              '1:gnomon_566853_mRNA:exon:5976',
              null,
            ],
            [
              1,
              ...
              'exon',
              '.',
              '1:gnomon_566853_mRNA:exon:5977',
              null,
            ],
            [
              1,
              ...
              'exon',
              '.',
              '1:gnomon_566853_mRNA:exon:5978',
              null,
            ],
            [
              1,
              ...
              'exon',
              '.',
              '1:gnomon_566853_mRNA:exon:5979',
              null,
            ],
            [
              1,
              ...
              'five_prime_UTR',
              '.',
              '1:gnomon_566853_mRNA:five_prime_utr',
              null,
            ],
            [
              1,
            ...
            [
              ...
              'three_prime_UTR',
              '.',
              '1:gnomon_566853_mRNA:three_prime_utr',
              null,
            ],
          ],
        ],
    ...
    it("should correctly set ['trackInfo']['intervals']['classes'] in jbrowse json", function () {
      expect(
        actualJbrowseJsonOutput['trackInfo']['intervals']['classes'],
      ).toEqual([
        {
          isArrayAttr: {
            Subfeatures: 1,
    ...
    it("should correctly set ['trackInfo']['intervals']['lazyClass'] in jbrowse json", function () {
      expect(
        actualJbrowseJsonOutput['trackInfo']['intervals']['lazyClass'],
      ).toEqual(2)
    })

    it("should correctly set ['trackInfo']['intervals']['urlTemplate'] in jbrowse json", function () {
      expect(
        actualJbrowseJsonOutput['trackInfo']['intervals']['urlTemplate'],
      ).toEqual('lf-{Chunk}.json')
    })

    it('_getFeaturesAtGivenDepth should correctly retrieve two level features from parsed gene GFF3', function () {
      var twoLevelFeat = store._getFeaturesAtGivenDepth(
        parsedGFF3toJbrowseJsonInput['parsedData'][0],
        2,
      )
          ...
          data: [
            {
              rawdata: [
                ...
                '+',
                '.',
                'ID=1:gnomon_566853_mRNA;Parent=this_parent_id_12345;Name=gnomon_566853_mRNA;_AED=0.45;_eAED=0.45;_QI=138|1|1|1|1|1|4|191|259;',
              ],
              attributes: {
                ID: ['1:gnomon_566853_mRNA'],
                Parent: ['this_parent_id_12345'],
                Name: ['gnomon_566853_mRNA'],
                _AED: ['0.45'],
                _eAED: ['0.45'],
                _QI: ['138|1|1|1|1|1|4|191|259'],
              },
            },
          ],
          children: [
              ...
              data: [
                {
                  rawdata: [
                    ...
                    '+',
                    '.',
                    'ID=1:gnomon_566853_mRNA:exon:5976;Parent=1:gnomon_566853_mRNA;',
                  ],
                  attributes: {
                    ID: ['1:gnomon_566853_mRNA:exon:5976'],
                    Parent: ['1:gnomon_566853_mRNA'],
                  },
                },
              ],
              children: [],
              ...
              data: [
                {
                  rawdata: [
                    ...
                    '+',
                    '.',
                    'ID=1:gnomon_566853_mRNA:exon:5977;Parent=1:gnomon_566853_mRNA;',
                  ],
                  attributes: {
                    ID: ['1:gnomon_566853_mRNA:exon:5977'],
                    Parent: ['1:gnomon_566853_mRNA'],
            ...
            {
              ID: '1:gnomon_566853_mRNA:exon:5978',
              data: [
                {
                  rawdata: [
                    'Group1.33',
                    ...
                    '+',
                    '.',
                    'ID=1:gnomon_566853_mRNA:exon:5978;Parent=1:gnomon_566853_mRNA;',
                  ],
                  attributes: {
                    ID: ['1:gnomon_566853_mRNA:exon:5978'],
                    Parent: ['1:gnomon_566853_mRNA'],
            ...
            {
              ID: '1:gnomon_566853_mRNA:exon:5979',
              data: [
                {
                  rawdata: [
                    'Group1.33',
                    ...
                    '+',
                    '.',
                    'ID=1:gnomon_566853_mRNA:exon:5979;Parent=1:gnomon_566853_mRNA;',
                  ],
                  attributes: {
                    ID: ['1:gnomon_566853_mRNA:exon:5979'],
                    Parent: ['1:gnomon_566853_mRNA'],
            ...
            {
              ID: '1:gnomon_566853_mRNA:five_prime_utr',
              data: [
                {
                  rawdata: [
                    'Group1.33',
                    ...
                    '+',
                    '.',
                    'ID=1:gnomon_566853_mRNA:five_prime_utr;Parent=1:gnomon_566853_mRNA;',
                  ],
                  attributes: {
                    ID: ['1:gnomon_566853_mRNA:five_prime_utr'],
                    Parent: ['1:gnomon_566853_mRNA'],
              ...
              data: [
                {
                  rawdata: [
                    ...
                    '+',
                    '1',
                    'ID=1:gnomon_566853_mRNA:cds;Parent=1:gnomon_566853_mRNA;',
                  ],
                  attributes: {
                    ID: ['1:gnomon_566853_mRNA:cds'],
                    Parent: ['1:gnomon_566853_mRNA'],
            ...
            {
              ID: '1:gnomon_566853_mRNA:three_prime_utr',
              data: [
                {
                  rawdata: [
                    'Group1.33',
                    ...
                    '+',
                    '.',
                    'ID=1:gnomon_566853_mRNA:three_prime_utr;Parent=1:gnomon_566853_mRNA;',
                  ],
                  attributes: {
                    ID: ['1:gnomon_566853_mRNA:three_prime_utr'],
                    Parent: ['1:gnomon_566853_mRNA'],
    ...
    it('_getFeaturesAtGivenDepth should correctly retrieve two level features from parsed gene GFF3 with two mRNAs', function () {
      ...
      var twoLevelFeat = store._getFeaturesAtGivenDepth(
        parsedGFF3toJbrowseJsonInput2['parsedData'][0],
        2,
      )
      expect(twoLevelFeat).toNotEqual(null)
      expect(twoLevelFeat).toEqual([
          ...
          data: [
            {
              rawdata: [
                ...
                '+',
                '.',
                'ID=mRNA_1;Parent=this_parent_id_12345;Name=mRNA_1;',
              ],
              attributes: {
                ID: ['mRNA_1'],
                Parent: ['this_parent_id_12345'],
              ...
              data: [
                {
                  rawdata: [
                    ...
                    '+',
                    '0',
                    'ID=cds_1.1;Parent=mRNA_1;',
                  ],
                  attributes: { ID: ['cds_1.1'], Parent: ['mRNA_1'] },
                },
              ],
              children: [],
            },
              ...
              data: [
                {
                  rawdata: [
                    ...
                    '+',
                    '0',
                    'ID=cds_1.2;Parent=mRNA_1;',
                  ],
                  attributes: { ID: ['cds_1.2'], Parent: ['mRNA_1'] },
                },
              ],
              children: [],
            },
              ...
              data: [
                {
                  rawdata: [
                    ...
                    '+',
                    '1',
                    'ID=cds_1.3;Parent=mRNA_1;',
                  ],
                  attributes: { ID: ['cds_1.3'], Parent: ['mRNA_1'] },
                },
              ],
              children: [],
            },
          ...
          data: [
            {
              rawdata: [
                ...
                '+',
                '.',
                'ID=mRNA_2;Parent=this_parent_id_12345;Name=mRNA_2;',
              ],
              attributes: {
                ID: ['mRNA_2'],
                Parent: ['this_parent_id_12345'],
              ...
              data: [
                {
                  rawdata: [
                    ...
                    '+',
                    '0',
                    'ID=cds_2.1;Parent=mRNA_2;',
                  ],
                  attributes: { ID: ['cds_2.1'], Parent: ['mRNA_2'] },
                },
              ],
              children: [],
            },
              ...
              data: [
                {
                  rawdata: [
                    ...
                    '+',
                    '0',
                    'ID=cds_2.2;Parent=mRNA_2;',
                  ],
                  attributes: { ID: ['cds_2.2'], Parent: ['mRNA_2'] },
                },
              ],
              children: [],
            },
              ...
              data: [
                {
                  rawdata: [
                    ...
                    '+',
                    '1',
                    'ID=cds_2.3;Parent=mRNA_2;',
                  ],
                  attributes: { ID: ['cds_2.3'], Parent: ['mRNA_2'] },
                },
              ],
              children: [],
            },
    ...
    it('_gff3toJbrowseJson should correctly retrieve two level features from parsed gene GFF3 with two mRNAs', function () {
      ...
      expect(twoLevelFeat['featArray']).toEqual([
        ...
        [
          ...
          'mRNA_2',
          [
            [1, 245759, 245879, '+', 'maker', '0', 'CDS', '.', 'cds_2.1', null],
            [1, 246045, 246278, '+', 'maker', '0', 'CDS', '.', 'cds_2.2', null],
            [1, 246388, 246815, '+', 'maker', '1', 'CDS', '.', 'cds_2.3', null],
          ],
        ],
      ])
    })
