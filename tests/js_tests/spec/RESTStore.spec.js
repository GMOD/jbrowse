require(['dojo/_base/lang', 'JBrowse/Store/SeqFeature/REST'], function (
  lang,
  RESTStore,
) {
    ...
    return function () {
      ...
      it('loads some data', function () {
        ...
        runs(function () {
          ...
          expect(features[4].children()[1].children()[0].get('type')).toEqual(
            'SNV',
          )
        })
      })
      ...
      if (!config.noCache) {
        ...
        it('supports feature_range_cache', function () {
          ...
          runs(function () {
            ...
            expect(features[3].children()[1].children()[0].get('type')).toEqual(
              'SNV',
            )
          })
        })
      ...
      it('supports feature histograms if implemented', function () {
        ...
        var hist
        var done
        withHist.getRegionFeatureDensities(
          { start: 0, end: 50000 },
          function (s) {
            hist = s
          },
