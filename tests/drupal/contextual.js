    ...
    attach: function (context) {
      $('div.contextual-links-wrapper', context).once(
        ...
        function () {
          ...
          var $trigger = $('<a class="contextual-links-trigger" href="#" />')
