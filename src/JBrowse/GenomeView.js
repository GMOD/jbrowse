 ...
 */
        ...
        zoomIn: function (e, zoomLoc, steps) {
            ...
            if ((steps == 0) && (this.pxPerBp == this.zoomLevels[this.curZoom])) {return;}
 ...
 */
        ...
        trackIterate: function (callback) {
            var i;
            for (i = 0; i < this.uiTracks.length; i++) {callback.call(this, this.uiTracks[i], this);}
            for (i = 0; i < this.tracks.length; i++) {callback.call(this, this.tracks[i], this);}
        },
