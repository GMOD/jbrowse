  ...
  return declare(InfoDialog, {
    ...
    _makeDefaultContent: function () {
      return (
        ...
        this.browser.resolveUrl('img/Empty.png') +
        '">  or <img class="icon nav" id="moveRightSmall" src="' +
        this.browser.resolveUrl('img/Empty.png') +
        ...
        '<dt>Zooming</dt>' +
        '<dd><ul>' +
        '    <li>Zoom in and out by clicking <img class="icon nav" id="zoomInSmall" src="' +
        this.browser.resolveUrl('img/Empty.png') +
        '"> or <img class="icon nav" id="zoomOutSmall" src="' +
        this.browser.resolveUrl('img/Empty.png') +
