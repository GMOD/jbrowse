...
return declare( 'JBrowse/View/FeatureGlyph/ProcessedTranscript', SegmentsGlyph, {
...
configSchema: {
    slots: [
        ...
        { name: 'impliedUTRs', type: 'boolean',
          description: 'If true, attempt to create UTR features based on the overlap of exon and CDS features.',
          defaultValue: false
        }
    ]
},
