    ...
    return declare(SegmentsGlyph, {
        ...
        renderSegments(context, fRect) {
            const styleFunc = (feature, stylename) => {
                if (stylename === 'height') {return this._getFeatureHeight(fRect.viewInfo, feature);} else if (stylename === 'color' && this.getConf('itemRgb', [feature, this])) {
            ...
            if (width > 3) {
                ...
                if (thickStart <= start && thickEnd >= end) {
                    ...
                    strokePoints = [
                        ...
                        [thickEndPx - halfLineWidth, bottom - thinHeightDiff - halfLineWidth],
                    ...
                    strokePoints = [
                        ...
                        [thickStartPx + halfLineWidth, top + thinHeightDiff + halfLineWidth],
                        ...
                        [thickStartPx + halfLineWidth, bottom - thinHeightDiff - halfLineWidth],
