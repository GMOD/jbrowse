define( "JBrowse/Store/Sequence/StaticMemoized", [ 'dojo/_base/declare',
          'dojo/_base/lang',
          'dojo/request',
          'dojo/promise/all',
          'dojo/Deferred',
 ...
 */
    ...
    _fetchChunk: function( sequrl, chunkNum ) {
        if (this.stored_sequence === undefined ){
            this.stored_sequence = request.get( sequrl + chunkNum + ".txt" + ( this.compress ? 'z' : '' ),
                            { handleAs: 'text' }
                          );
        }
        return this.stored_sequence;
    },
