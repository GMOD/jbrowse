        ...
        ],
        {
            ...
            constructor(args) {
                ...
                this.indexedData = new TabixIndexedFile({
                    ...
                    tbiFilehandle:
                        tbiBlob && new BlobFilehandleWrapper(tbiBlob),
                    csiFilehandle:
                        csiBlob && new BlobFilehandleWrapper(csiBlob),
                    chunkSizeLimit: args.chunkSizeLimit || 50000000,
                    renameRefSeqs: (n) =>
                        this.browser.regularizeReferenceName(n),
                });
