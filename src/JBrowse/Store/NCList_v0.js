 ...
 */
        ...
        NCList_v0.prototype.binarySearch = function (arr, item, itemIndex) {
            ...
            if (itemIndex == 1) return high; return low;
        };
        ...
        NCList_v0.prototype.iterHelper = function (arr, from, to, fun, finish,
           ...
           && ((inc * arr[i][testIndex]) < (inc * to))) {
                if (typeof arr[i][this.lazyIndex] === 'object') {
                    var ncl = this;
                    // lazy node
                    if (arr[i][this.lazyIndex].state) {
                        if (arr[i][this.lazyIndex].state == 'loading') {
                        ...
                        } else if (arr[i][this.lazyIndex].state == 'loaded') {
                            // just continue below
                        } else {
