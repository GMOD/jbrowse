...
function (
     ...
     */
        ...
        isRightButton: function (e) {
            ...
            if (e.which) {return e.which == 3;} else if (e.button) {return e.button == 2;}
            return false;
        },
     ...
     */
        ...
        removeAttribute: function (domNode, attrName) {
            try { delete domNode[attrName]; } catch (e) {
