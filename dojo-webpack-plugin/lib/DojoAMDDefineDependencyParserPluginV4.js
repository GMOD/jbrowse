...
module.exports = class DojoAMDDefineDependencyParserPluginV4 extends
DojoAMDDependencyParserMixin(AMDDefineDependencyParserPlugin) {
	...
	apply(parser) {
		tap(parser, "call define", this.processCallDefine.bind(this, parser));
	}

	processCallDefine(parser, ...rest) {
		parser.state.module.isAMD = true;
		return super.processCallDefine(parser, ...rest);
	}
};
