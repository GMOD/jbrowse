  ...
  my $jbCode = <<JBCODE;
    ...
    /* <![CDATA[ */
		 ...
		 function makeBookmark() {
		     ...
		     bookmarkURL = '$editUrl' + bookmarkTime + '?topic=$jbTopic&text=%25JBROWSE%7BshowTracks=%22' + jbrowseTrackList + '%22%20navigateTo=%22' + jbrowseLocation + '%22%7D%25%0D%0D(Bookmarked%20from%20$jbTopic)&topicparent=$topic';
